...
CCDEF cc_Mesh *LoadObj(const char *filename)
{
    ...
    end_func_time = clock();
    CC_LOG("Complete (%f's) - Read Mesh size",(double)(end_func_time - start_func_time) / CLOCKS_PER_SEC);
    ...
    rewind(stream);
    end_func_time = clock();
    CC_LOG("Complete (%f's) - Initalise and count", (double)(end_func_time - start_func_time) / CLOCKS_PER_SEC);
...
CC_BARRIER
    ...
    end_func_time = clock();
    CC_LOG("Complete (%f's) - Generating Crease Data", (double)(end_func_time - start_func_time) / CLOCKS_PER_SEC);
    ...
    end_func_time = clock();
    CC_LOG("Complete (%f's) - Crease Neighbors", (double)(end_func_time - start_func_time) / CLOCKS_PER_SEC);

    end_time = clock();
    CC_LOG("Duration: %f 's",(double)(end_time - start_time) / CLOCKS_PER_SEC);
